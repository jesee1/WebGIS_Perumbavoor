...
map.getView().fit([8509585.272530, 1130540.847248, 8517958.570919, 1134547.528208], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PERUMBAVOOR WEB GIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (54 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'As part of my M.Sc programe, this website is created. ';
            }
